...
// Insight dashboard
const AsyncInsightDashboardComponent = Loadable({
   loader: () => import("Routes/dashboard/insight"),
...
// Marketplace
const AsyncMarketplaceComponent = Loadable({
   loader: () => import("Routes/marketplace"),
   loading: () => <RctPageLoader />,
});
// Marketplace
const AsyncIntroductoryProgrammingComponent = Loadable({  
   loader: () => import("Routes/introductoryprogramming"), 
   loading: () => <RctPageLoader />,
});
...
// Class Internal
const AsyncClassInternalComponent = Loadable({
   loader: () => import("Routes/my-classes/internal"),
   loading: () => <RctPageLoader />,
});

// Class External
const AsyncClassExternalComponent = Loadable({
   loader: () => import("Routes/my-classes/external"),
   loading: () => <RctPageLoader />,
});
// Student Internal
const AsyncStudentInternalComponent = Loadable({
   loader: () => import("Routes/my-students/internal"),
   loading: () => <RctPageLoader />,
});

// Student External
const AsyncStudentExternalComponent = Loadable({
   loader: () => import("Routes/my-students/external"),
   loading: () => <RctPageLoader />,
});
...
export {
   ...
   AsyncStudentInternalComponent,
    ...
    AsyncIntroductoryProgrammingComponent
};
