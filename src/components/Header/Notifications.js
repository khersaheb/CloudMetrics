...
class Notifications extends Component {
   ...
   render() {
      ...
      return (
         <UncontrolledDropdown nav className="list-inline-item notification-dropdown mr-0 ml-3">
            <DropdownToggle nav className="p-0">
               <Tooltip title="Notifications" placement="bottom">
                  <IconButton className="shake notification-btn" aria-label="bell">
                     <i className="zmdi zmdi-notifications-none"></i>
                     <Badge color="danger" className="badge-xs n-badge badge-top-right rct-notify">2</Badge>
                  </IconButton>
               </Tooltip>
            </DropdownToggle>
            <DropdownMenu right>
