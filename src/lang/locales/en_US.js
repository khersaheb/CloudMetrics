module.exports = {
   ...
   "widgets.plan": "Plan",
   "widgets.basic": "Basic",
   "widgets.introtoProgramming": "Intro to Programming",
   "widgets.historytechnologysecurity": "History, Technology & Security",
   "widgets.introtodatamining": "Intro to Data Mining",
   "widgets.webdevelopment": "Web Development",   
   "widgets.seecourse": "See Course",
   "widgets.pro": "Pro",
   ...
   "sidebar.rizeTracks": "Rize Tracks",
   "sidebar.marketplace" : "Marketplace",
   "sidebar.marketplacetitle" : "Available Classes for Purchase",
   "sidebar.myProfile" : "My Profile",
   "sidebar.myClasses" : "My Classes",
   "sidebar.internal" : "Internal",
   "sidebar.studentsinternal" : "Internal Students Taking Classes at Other Colleges",
   "sidebar.studentsexternal" : "External Students Taking Classes at My College",
   "sidebar.classinternal" : "My classes Availble to Other Colleges",
   "sidebar.classexternal" : "Other Colleges Classes Added to My Course Catalog",
   "sidebar.external" : "External",
   "sidebar.myStudents" : "My Students",
   "sidebar.contact" : "Contact",
   "sidebar.home":"Home",
   "sidebar.techcomputerscienceasliberalart":"Tech & Computer Science as Liberalart",
   "sidebar.computersciencetechnology":"Computer Science & Technology",
   "sidebar.introductoryprogramming":"Introductory Programming",


   "sidebar.insights": "Insights",
   "sidebar.optimize": "Optimize",
   "sidebar.automate": "Automate",
   "sidebar.plan": "Plan",
