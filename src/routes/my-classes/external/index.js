...
export default class AsyncClassExternalComponent extends Component {
   ...
   render() {
      ...
      return (
         <div className="user-management">
            <Helmet>
               <title>My Classes External</title>
               <meta name="description" content="My Student External" />
            </Helmet>
            <PageTitleBar
               title={<IntlMessages id="sidebar.classexternal" />}
