   ...
   render() {
      ...
      return (
         <div className="user-management">
            <Helmet>
               <title>Reactify | My Profile</title>
               <meta name="description" content="My Profile" />
            </Helmet>
            <PageTitleBar
               title={<IntlMessages id="sidebar.myProfile" />}
                              ...
                              <td>
                                 <div className="media">
                                    ...
                                    <div className="media-body">
                                       <h5 className="mb-5 fw-bold">John Doe</h5>
                                    </div>
                                 </div>
                              </td>
                              <td>Registrar</td>
                              <td>{user.emailAddress}</td>
                              <td>(555) 5555-55555</td>
            ...
            <RctCollapsibleCard heading="Academic Celender" >
               <div className="row">
            ...
            <RctCollapsibleCard heading="Payment Information">
               <div className="row">
                  <div className="col-sm-12 col-md-4">
                     <Select value="Sending Funds">
                        <MenuItem value=""><em>None</em></MenuItem>
                        <MenuItem value="Sending Funds">Sending Funds</MenuItem>
                        <MenuItem value="Receiving Funds">Receiving Funds</MenuItem>
                     </Select>
                  </div>
               </div>
            </RctCollapsibleCard>
