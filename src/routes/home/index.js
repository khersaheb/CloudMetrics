...
import TestimonialSlider from '../about-us/components/testimonial-slider';
import Clientslider from '../about-us/components/client-slider';
	...
	render() {
		return (
			<div className="about-wrapper">
				...
				<PageTitleBar title={<IntlMessages id="sidebar.home" />} match={this.props.match} />
				<div className="about-detail">
					...
					<RctCard>
						<div className="row align-items-center p-15 ">
							<div className="col-sm-12">
								<div className="about-content align-items-center text-center">
									...
									<Button component={Link} to="/signin" variant="contained" className="btn-primary btn-lg w-25 text-white text-center">Login</Button>
								</div>
							</div>
						</div>
					</RctCard>
