...
export default class AsyncMarketplaceComponent extends Component {
   ...
   render() {
      ...
      return (
         <div className="user-management">
            ...
            <PageTitleBar
               title={<IntlMessages id="sidebar.marketplacetitle" />}
            ...
            <RctCollapsibleCard fullBlock>
               <div className="table-responsive">
                  ...
                  <table className="table table-middle table-hover mb-0">
                     ...
                     <tbody>
                        <tr>                                                         
                           <td><Link component={Link} to="/app/marketplace/introductoryprogramming" >Introductory Programming </Link></td>
                           <td>Tech & CS as a Liberal Art</td>   
                           <td>Computer Science: Liberal Art</td>                          
                           <td>4</td>
                           <td>Introductory</td>
                           <td>Siemens, Dominoes, L Brands</td> 
                           <td><Button component={Link} to="/" variant="contained" className="btn-primary text-white text-center">See Course </Button></td>
                        </tr> 
                        <tr>                                                         
                           <td><Link component={Link} to="/" >Global History</Link></td>
                           <td></td>   
                           <td>History</td>
                        ...
                        <tr>                                                         
                           <td><Link component={Link} to="/" >Introductory Calculus</Link></td>
                           <td></td>   
                           <td>Math</td>                          
                        ...
                        <tr>                                                         
                           <td><Link component={Link} to="/" >Supply Chain Management III</Link></td>
                           <td>Supply Chain Management</td>   
                           <td>Business, Finance, Economics</td>                          
                           <td>Bay Parth University</td>
                           <td>Elective</td>
                           <td>Assurex Global, National Hockey League..</td> 
                           <td><Button component={Link} to="/" variant="contained" className="btn-primary text-white text-center">See Course </Button></td>
                        </tr>    
                        <tr>                                                         
                           <td><Link component={Link} to="/" >Microsoft Excel</Link></td>
                           <td>Microsoft Office</td>   
                           <td>Electives</td>                          
                           <td>Trine University</td>
                           <td>Elective</td>
                           <td>Honeywell, Mastercard...</td> 
                           <td><Button component={Link} to="/" variant="contained" className="btn-primary text-white text-center">See Course </Button></td>
                        </tr>                                                                                 
                     </tbody>
